...
class RecruitmentsAPI {
  ...
  getAllPostForUser = async (payload: any) => {
    const data = await apiEnterprise.post('/api/Cv/Candidate/PostForUser', payload);
    return data.data;
  };
  getAllPostForUserApprove = async (payload: any) => {
    const data = await apiEnterprise.post('/api/Cv/Candidate/listPostuserId', payload);
    return data.data;
  };
  ...
  DeletePostCandidate = async (payload: any) => {
    const { data } = await apiEnterprise.post(`/api/Cv/Candidate/Delete`, payload);
    return data;
  };
}

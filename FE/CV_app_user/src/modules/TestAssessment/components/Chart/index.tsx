...
const customPolarAngleAxisTick: React.FC = (tickProps: any, chartData: any) => {
  ...
  if (active && payload && payload.length) {
    return (
      <div className={styles.custom_tooltip}>
        <p className="label">{`${payload[0].payload.subject} : ${payload[0].value} / ${payload[0].payload.fullMark}`}</p>
...
const VariantChart: React.FC<IProps> = (props: IProps) => {
